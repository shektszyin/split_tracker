...
import { Calendar, ArrowDownLeft, ArrowUpRight, Scale } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center pt-8 pb-4">
      ...
      <div className="text-center mb-8">
        ...
        <div className="text-zinc-500 text-sm font-medium tracking-wide">Total Spent</div>
      </div>
        ...
        <div className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex items-center justify-between relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2 text-blue-400 mb-0.5">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider">Settlement</span>
                </div>
...
// Helper component for empty state if needed, though usually not imported
